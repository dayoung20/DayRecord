...
public class SigninFinishActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvName.setText(((SigninActivity)SigninActivity.SigninContext).signID.getText());
        ...
        startRecord.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(SigninFinishActivity.this, ScheduleActivity.class);
